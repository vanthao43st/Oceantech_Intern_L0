...
public class StudentArrayController {
    ...
    public static Student findStudentById(Student[] studentLists) {
        ...
        try {
            ...
            System.out.println("Nhap ID khong dung, ID la so nguyen trong khoang (1 - " + studentCount + ").");
            sc.next();
        }
        while (id <= 0 || id > studentCount) {
            System.out.print("ID khong hop le (1 - " + studentCount + "). Vui long nhap lai. ");
            try {
                id = sc.nextInt();
            } catch (Exception e) {
                System.out.println("Nhap ID khong dung, ID la so nguyen trong khoang (1 - " + studentCount + ").");
